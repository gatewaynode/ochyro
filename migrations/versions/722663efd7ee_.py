...
Revision ID: 722663efd7ee
Revises: 
Create Date: 2020-01-01 18:38:38.700395
...
def upgrade():
    ...
    op.create_index(op.f('ix_node_meta'), 'node', ['meta'], unique=False)
    ...
    op.create_index(op.f('ix_node_revision_meta'), 'node_revision', ['meta'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_node_revision_meta'), table_name='node_revision')
    ...
    op.drop_index(op.f('ix_node_meta'), table_name='node')
